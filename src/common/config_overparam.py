...
# Layer schedules
# ------------------------------------------------------------
# Shared by all DPQC/reset and Unitary-PQC training and analysis stages.
MAX_LAYER = 16
DENSE_UNTIL_LAYER = 8
SPARSE_STEP = 2

# DPQC/reset VQE optimization
VQE_MAX_LAYER = MAX_LAYER
VQE_DENSE_UNTIL_LAYER = DENSE_UNTIL_LAYER
VQE_SPARSE_STEP = SPARSE_STEP

# Unitary-PQC VQE optimization
UNITARY_PQC_MAX_LAYER = MAX_LAYER
UNITARY_PQC_DENSE_UNTIL_LAYER = DENSE_UNTIL_LAYER
UNITARY_PQC_SPARSE_STEP = SPARSE_STEP

# DPQC/reset random-point QFIM/Hessian analyses
DPQC_QFIM_MAX_LAYER = MAX_LAYER
DPQC_QFIM_DENSE_UNTIL_LAYER = DENSE_UNTIL_LAYER
DPQC_QFIM_SPARSE_STEP = SPARSE_STEP

# Unitary-PQC random-point QFIM/derivative analyses
UNITARY_PQC_QFIM_MAX_LAYER = MAX_LAYER
UNITARY_PQC_QFIM_DENSE_UNTIL_LAYER = DENSE_UNTIL_LAYER
UNITARY_PQC_QFIM_SPARSE_STEP = SPARSE_STEP

# Backward-compatible aliases for the former DPQC-only QFIM names.
QFIM_MAX_LAYER = MAX_LAYER
QFIM_DENSE_UNTIL_LAYER = DENSE_UNTIL_LAYER
QFIM_SPARSE_STEP = SPARSE_STEP
...
# Save trace-based / participation-rank QFIM diagnostics at random parameter
# points in addition to the legacy threshold-rank outputs.  Participation
# ranks use the same active spectrum,
# lambda > QFIM_EFFECTIVE_RANK_THRESHOLD.  This switch does not trigger
# independent QFIM evaluations: all metrics are derived from the same
# eigendecomposition.
