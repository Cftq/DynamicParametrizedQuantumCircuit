#!/usr/bin/env python
# coding: utf-8
"""Lightweight command-line options for independent outcome-1 stages."""
...
def parse_stage_args(stage: str, argv=None):
    descriptions = {
        "vqe": "Train the outcome-1 Unitary-PQC and save optimization results only.",
        "qfim": "Compute outcome-1 QFIM/HS without training or Hessian calculation.",
        "hessian": "Compute outcome-1 Hessians independently of VQE and QFIM.",
    }
...
def parse_compute_args(argv=None):
    parser = argparse.ArgumentParser(
        description=("Launch independent outcome-1 Unitary-PQC programs. "
