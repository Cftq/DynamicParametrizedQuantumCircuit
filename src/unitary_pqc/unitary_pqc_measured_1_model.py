#!/usr/bin/env python
# coding: utf-8
"""Lightweight shared definition of the outcome-1 U3-Cartan circuit.

Each layer contains four independent 15-angle pair blocks followed by the
two-angle outcome-1 feed-forward operation. Importing this module does not
...
NUM_PARAMS_PER_LAYER = UNITARY_PARAMS_PER_LAYER + FEED_FORWARD_PARAMS_PER_LAYER
LAYER_PAIRS = (
    (1, 3),
    (2, 3),
    (0, 2),
